    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_blur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bitmap iv = BitmapFactory.decodeResource(getResources(),
                        R.drawable.blur_test);

                iv_blur.setImageBitmap(fastblur(iv, 1, 30));
            }
        });
    }

    //http://stackoverflow.com/a/10028267/1820217
